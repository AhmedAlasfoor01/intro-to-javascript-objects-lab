...
*/
 ...
 game.party.slice(0, 1, evolvedStarter);
...
game.catchpokemon = function(pokemonobj){
  ...
  for (let i=0; i < game.items.length; i++){
    if(game.items[i].name ==="pokballs"){
      game.items[i].quantity = game.items[i].quantity -1;
    }
  }
}; 
...
console.log("You got", game.partyCount(), "Pokémon in your party.");
